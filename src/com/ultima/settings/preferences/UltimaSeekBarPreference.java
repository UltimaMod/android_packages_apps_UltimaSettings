...
public class UltimaSeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    public UltimaSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPreference(context, attrs);
    }

    public UltimaSeekBarPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        ...
        mMinValue = attrs.getAttributeIntValue(SETTINGS, "seekmin", 0);
